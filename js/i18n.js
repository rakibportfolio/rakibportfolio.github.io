...
const I18N_DATA = {
  en: {
    ...
    ref_btn_together: "LET'S WORK TOGETHER",
    ref_btn_view_work: "VIEW MY WORK →",
    ref_nav_home: "Home",
    ref_nav_portfolio: "Portfolio",
    ref_nav_about: "About",
    ref_nav_services: "Services",
    ref_nav_contact: "Contact",
    ref_nav_create: "Let's Create →",
    ref_brand_role: "VIDEO EDITOR",
    ref_floating_role: "VIDEO EDITOR",
  ...
  bn: {
    ref_hero_tag: "ভিডিও এডিটর • ক্রিয়েটিভ স্টোরিটেলার",
    ref_hero_title_1: "সাধারণ কাঁচা ফুটেজকে আমি রূপান্তর করি",
    ref_hero_title_into: "",
    ref_hero_title_2: "আকর্ষণীয় ভিজ্যুয়াল গল্পে।",
    ref_hero_desc: "প্রফেশনাল ভিডিও এডিটিং, সিনেমাটিক ইফেক্টস এবং বিফোর/আফটার ট্রান্সফর্মেশন যা আপনার কনটেন্টকে করে তোলে অনন্য ও নজরকাড়া।",
    ref_btn_whatsapp: "হোয়াটসঅ্যাপ: 01716705401",
    ref_btn_together: "একসাথে কাজ শুরু করুন",
    ref_btn_view_work: "আমার কাজ দেখুন →",
    ref_nav_home: "হোম",
    ref_nav_portfolio: "পোর্টফোলিও",
    ref_nav_about: "সম্পর্কে",
    ref_nav_services: "সার্ভিসেস",
    ref_nav_contact: "যোগাযোগ",
    ref_nav_create: "শুরু করা যাক →",
    ref_brand_role: "ভিডিও এডিটর",
    ref_floating_role: "ভিডিও এডিটর",
